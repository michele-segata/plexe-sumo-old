...
GUIDialog_AboutSUMO::GUIDialog_AboutSUMO(FXWindow* parent) :
    FXDialogBox(parent, "About PLEXE SUMO", GUIDesignDialogBox) {
    // set dialog icon
    ...
    FXLabel* neteditLabel = new FXLabel(descriptionFrame, "PLEXE SUMO " VERSION_STRING, 0, GUIDesignLabelAboutInfo);
    ...
    new FXLabel(this, "Includes the Platooning Extension for Veins (PLEXE)", 0, LABEL_NORMAL, 0, 0, 0, 0, 0, 0, 0, 0);
    new FXLabel(this, "Copyright (C) 2001-2017 DLR / Institute of Transportation Systems", 0, GUIDesignLabelAboutInfo);
    new FXLabel(this, "Copyright (C) 2012-2016 Michele Segata (segata@ccs-labs.org)", 0, LAYOUT_CENTER_X | JUSTIFY_CENTER_X | LABEL_NORMAL, 0, 0, 0, 0, 0, 0, 0, 0);

    // link to homepage
    FXLinkLabel* link = new FXLinkLabel(this, "http://sumo.dlr.de", 0, GUIDesignLabelCenter);
    link->setTipText("http://sumo.dlr.de");
    FXLinkLabel* plexeLink = new FXLinkLabel(this, "http://plexe.car2x.org", 0, LAYOUT_CENTER_X | JUSTIFY_CENTER_X | LABEL_NORMAL, 0, 0, 0, 0, 5, 5, 5, 5);
    plexeLink->setTipText("http://plexe.car2x.org");
